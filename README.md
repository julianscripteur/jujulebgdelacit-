--[[cree par juju le bg de la cité
Discord:https://discord.gg/Sa8GyZNK
Dont change or u can get banned !!! not my fault if U get banned
--]]
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Window  = Library.CreateLib("Script cree par le bg ", "BloodTheme")
local Tab     = Window:NewTab("Scripts")
local Section = Tab:NewSection("achete NFT (With Game Money!)")
Section:NewButton("achete un ben", "achete  Ben", function()
    local args = {
        [1] = "Trading Ben"
    }
...
Section:NewButton("achete munneh nft", "achete nft", function()
    local args = {
        [1] = "Munneh"
    }
...
Section:NewButton("achete Mommeh Long Legs", "achete Mommeh Long Legs", function()
    local args = {
        [1] = "Mommeh Long Legs"
    }
...
local Section = Tab:NewSection("Crash Server installe un uto clicker")
Section:NewButton("Crash le server", "mais l auto cliker sur le bouton tu dois aoir 19miliard", function()
    local args = {
    [1] = "Jet"
    }
...
Section:NewKeybind("fermer F ouvrir F", "Close F open F", Enum.KeyCode.F, function()
    Library:ToggleUI()
end)
Section:NewLabel("Teleport au trade")
Section:NewButton("trade 1", "ButtonInfo", function()
...
Section:NewButton("trade 2", "ButtonInfo", function()
...
Section:NewButton("trade 3", "ButtonInfo", function()
...
Section:NewButton("trade 4", "ButtonInfo", function()
...
Section:NewButton("trade 5", "ButtonInfo", function()
...
Section:NewButton("trade 6", "ButtonInfo", function()
...
Section:NewButton("trade 7", "ButtonInfo", function()
...
Section:NewButton("trade 1(autre coter)", "ButtonInfo", function()
...
Section:NewButton("trade 2(autre coter)", "ButtonInfo", function()
...
Section:NewButton("trade 3(autre coter)", "ButtonInfo", function()
...
Section:NewButton("trade 4(autre coter)", "ButtonInfo", function()
...
Section:NewButton("trade 5(autre coter)", "ButtonInfo", function()
...
Section:NewButton("trade 6(autre coter)", "ButtonInfo", function()
...
local Tab     = Window:NewTab("Duplique ici")
local Section = Tab:NewSection("ici tu peux tout dupliquer click plusieur foix pas trop vite sur un boutton dupe !")
Section:NewToggle("Auto Duplique Banana", "Dupe Banana", function(state)
    if state then
_G.on = true
...
local Section = Tab:NewSection("cree par juju")
